            ...
            "patternProperties": {
                ".*": {
                    ...
                    "properties": {
                        ...
                        "races_completed": {"type": "integer", "minimum": 0},
                        "races_analyzed": {"type": "integer", "minimum": 0},
                        "championship_position": {"type": "integer", "minimum": 1},
                        "normalized_overall_pace": {"type": "number"},
                        "normalized_slow_corner_performance": {"type": "number"},
                        "normalized_medium_corner_performance": {"type": "number"},
                        "normalized_fast_corner_performance": {"type": "number"},
                        "normalized_top_speed": {"type": "number"},
                        "normalized_consistency": {"type": "number"},
                        "normalized_tire_deg_performance": {"type": "number"},
            ...
            "patternProperties": {
                ".*": {
                    ...
                    "properties": {
                        ...
                        "vsc_prob": _UNIT_INTERVAL_NUMBER,
                        "multi_sc_prob": _UNIT_INTERVAL_NUMBER,
